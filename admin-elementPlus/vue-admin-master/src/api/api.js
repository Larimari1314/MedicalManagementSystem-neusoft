...
//查找科室列表
export const getDepartClassList =params=>{
    return axios.get(`${parameter}/departClassification/getDepartClassList`,{params:params});
};
//查找科室
...
//查找性别
export const findGender =params=>{
    return axios.get(`${parameter}/generalitem/findGender`,{params:params});
};
