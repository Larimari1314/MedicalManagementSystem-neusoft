<template>
  <section>
    ...
    <el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
      ...
      <el-table-column prop="avatarUrl" width="180" label="用户头像" scope="scope">
      ...
      <el-table-column prop="identityNumber" label="身份证号" min-width="180">
      </el-table-column>
    ...
    <el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
      <el-form :model="editForm" label-width="80px" ref="editForm">
        ...
        <el-form-item label="性别" prop="sex">
          <el-select v-model="editForm.sex" placeholder="请选择" disabled>
            <el-option
                v-for="item in Genders"
                :key="item.coding"
                :label="item.value"
        ...
        <el-form-item label="身份证号">
          <el-input v-model="editForm.identityNumber" disabled></el-input>
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="上传表单" v-model="uploadServerVisibleUser" :close-on-click-modal="false">
      ...
      <el-upload
          ...
          drag
          :limit="1"
          action="http://localhost:8000/hospital/user/uploadToServer"
          :file-list="fileList"
    ...
    <el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
      <el-form :model="addForm" label-width="80px" ref="addForm">
        ...
        <el-form-item label="身份证号" prop="identityNumber" :rules="[
