  ...
  <section>
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters">
        ...
        <el-form-item>
          <el-button type="success" v-on:click="getUsers">设置排班时间</el-button>
    ...
    <el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
      ...
      <el-table-column prop="name" label="医生id" width="150" sortable>
      </el-table-column>
      <el-table-column prop="sex" label="医生姓名" width="150" :formatter="formatSex" sortable>
      </el-table-column>
      <el-table-column prop="age" label="年龄" width="100" sortable>
      </el-table-column>
      <el-table-column prop="age" label="性别" width="100" sortable>
      </el-table-column>
      <el-table-column prop="age" label="挂号级别" width="120" sortable>
      </el-table-column>
      <el-table-column prop="age" label="排班" width="120" sortable>
      </el-table-column>
